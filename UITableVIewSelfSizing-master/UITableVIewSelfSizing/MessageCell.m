...
- (void)setMessage:(CellModel *)message {
    ...
    // 创建姓名
//    [[NSAttributedString alloc]initWithString:message.name attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:15],NSForegroundColorAttributeName:[UIColor blueColor]}];
